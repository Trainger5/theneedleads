...
<body>
                            ...
                            <ul class="services_dropdown_box">
                                ...
                                <li class="navdrop">
                                    ...
                                    <ul class="childdrop" id="dropshowtwo">
                                        ...
                                        <li>
                                            <a href="<?php echo $linkBase ?? ''; ?>dynamic-website.php">Dynamic Website</a>
                                        </li>
                                        <li>
                                            <a href="<?php echo $linkBase ?? ''; ?>ecommerce-website.php">Ecommerce Website</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="<?php echo $linkBase ?? ''; ?>website-maintenance.php">Website Maintenance</a>
                                </li>
                                <li>
                                ...
                                <li>
                                    <a href="<?php echo $linkBase ?? ''; ?>local-seo-services.php">Local SEO Services</a>
                                </li>
                                <li>
    ...
    <div class="call-back-1">
        <a href="tel:+918750500075"><img src="<?php echo $assetBase ?? ''; ?>assets/img/call.png" style="margin-left: 82px;" alt="call Needleads"
                title="call-Needleads"></a>
        <a href="https://wa.link/0p3op6" target="_blank">
            <img src="<?php echo $assetBase ?? ''; ?>assets/img/whatsapp-img.png" style="margin-left: 82px;" alt="whatsapp"
    ...
    <div class="porsetofside">
        <div class="btnofportfolio">
            ...
            <a href="<?php echo $linkBase ?? ''; ?>portfolio.php">Our Portfolio</a>
        </div>
    </div>
    ...
    <div class="modal" id="pdfdown">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="bnrform">
                        <form action="<?php echo $linkBase ?? ''; ?>pdfform.php" method="POST" id="emailForm">
    ...
    <div class="modal" id="pdfdowntwo">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="bnrform">
                        <form action="<?php echo $linkBase ?? ''; ?>case-study-varification.php" method="POST" id="emailForm">
