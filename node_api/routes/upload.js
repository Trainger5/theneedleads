...
// Prefer explicit UPLOAD_DIR, otherwise default to ../blog/assets/images
const UPLOAD_DIR =
...
router.post("/image", requireAdmin, upload.single("image"), (req, res) => {
  ...
  // Default matches README/.env.example: /blog/assets/images
  const publicBase = (process.env.PUBLIC_UPLOAD_BASE || "/blog/assets/images").replace(
    /\/$/,
    ""
  );
