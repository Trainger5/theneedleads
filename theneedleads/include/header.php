        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="imgoffer">
                        <img src="assets/img/new-year.jpg" class="desktopoffer">
                        <img src="assets/img/new-year.jpg" class="mobilepoffer">
                    </div>
                </div>
            ...
            <div class="header_inner_box">
                ...
                <nav>
                    ...
                    <ul class="nav-list">
                        ...
                        <li class="services_dropdown">
                            <a href="Products.php" id="dropftwo" class="product">
                        ...
                        <li class="services_dropdown">
                            ...
                            <a href="javascript:void()">Features <i class="fa fa-sort-desc setofdowntop"
                                    aria-hidden="true"></i></a>
                            <ul class="services_dropdown_box">
                                <li><a href="free-seo-analysis.php">Free SEO Analysis</a></li>
                                <li><a href="page-speed-analysis.php">Page Speed Analysis</a></li>
                                <li><a href="google-penalty-analysis.php">Google Penalty Analysis</a></li>
                                <li><a href="google-partner-india.php">Google Channel Partner</a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li class="webbtnset headermenu">
                            <a href="booking.php" class="booking-btn">Book Now ! </a>
                        </li>
                    </ul>
                </nav>
            </div>
