...
<header class="admin-header">
    <div class="admin-header-inner">
      ...
      <div class="admin-actions">
        <a class="admin-link" href="<?php echo htmlspecialchars($site_cfg["basePath"]); ?>">ā? View Blog</a>
      </div>
    </div>
  </header>
      ...
      <section class="admin-panel modal-panel">
        ...
        <form id="postForm" class="post-form">
          ...
          <div class="image-preview">
            ...
            <img id="imagePreview" src="<?php echo htmlspecialchars($site_cfg["basePath"]); ?>assets/images/placeholder.svg" alt="preview" onerror="this.src='/assets/images/placeholder.svg'"/>
          </div>
        </form>
      </section>
    </div>
